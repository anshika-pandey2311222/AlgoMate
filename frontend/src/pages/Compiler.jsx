...
function greet(user){
  return 'Welcome to AlgoMate!, made by Anshika Pandey';
}
console.log(greet("World"));`,
      python: `# Python Example
print("Welcome to AlgoMate!, made by Anshika Pandey")`,
      c: `#include <stdio.h>
int main(){
  printf("Welcome to AlgoMate!, made by Anshika Pandey");
  return 0;
}`,
      cpp: `#include <bits/stdc++.h>
using namespace std;
int main(){
  cout << "Welcome to AlgoMate!, made by Anshika Pandey";
  return 0;
}`,
      java: `public class Main {
  public static void main(String[] args){
    System.out.println("Welcome to AlgoMate!, made by Anshika Pandey");
  }
}`
    }),
    []
    ...
    <div className="w-full min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 text-white">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 md:grid-cols-2 gap-4 p-6">
        ...
        <div className="rounded-2xl border border-neutral-700 bg-black/30 backdrop-blur-lg shadow-xl">
          <div className="flex items-center justify-between px-4 py-2 border-b border-neutral-700">
            ...
            <button
              onClick={runCode}
              disabled={isRunning}
              className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg font-semibold shadow-md disabled:opacity-50"
            >
        ...
        <div className="rounded-2xl border border-neutral-700 bg-black/30 backdrop-blur-lg shadow-xl">
          ...
          <pre className="h-[75vh] overflow-auto p-4 text-base whitespace-pre-wrap text-green-300 bg-black/40 rounded-b-2xl">
            {output}
          </pre>
        </div>
      </div>
